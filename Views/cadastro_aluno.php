...
<center>
    ...
    <form action="../Models/enviar_aluno.php" method="post">
        <table border="0" class="table">
            ...
            <tr><td>Data de Nascimento</td><td><input type="date" class="form-control" min="1920-12-31" max="1996-01-01" name="aniversario_aluno" placeholder="DD/MM/AAAA" size="20" required></td></tr>
            <tr><td>Endereço do Aluno</td><td><input type="text" class="form-control" name="endereco_aluno" size="60" required></td></tr>
            <tr><td>Cidade</td><td><input type="text" class="form-control" name="cidade_aluno" size="60" required></td></tr>
            <tr><td>Estado</td><td>
    ...
    <a href="listar_aluno.php">Voltar</a>
</center>
<?php
